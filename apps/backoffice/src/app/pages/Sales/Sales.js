...
//
import SALESLIST from '../../../assets/mockup/sales';
...
function applySortFilter(array, comparator, query) {
  ...
  if (query) {
    return filter(
      array,
      (sales) =>
        sales.orderNumber.toLowerCase().indexOf(query.toLowerCase()) !== -1
    );
  }
