...
function startDevServer(opts, context) {
    return tslib_1.__asyncGenerator(this, arguments, function* startDevServer_1() {
        ...
        const { project, target, configuration } = devkit_1.parseTargetString(opts.devServerTarget);
        const devServerTargetOpts = devkit_1.readTargetOptions({ project, target, configuration }, context);
