 ...
 */
export declare function removeDependenciesFromPackageJson(host: Tree, dependencies: string[], devDependencies: string[], packageJsonPath?: string): GeneratorCallback;
