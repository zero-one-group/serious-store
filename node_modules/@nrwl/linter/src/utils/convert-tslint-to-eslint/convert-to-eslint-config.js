...
function getConvertToEslintConfig() {
    ...
    child_process_1.execSync(`${package_manager_1.getPackageManagerCommand().addDev} tslint-to-eslint-config@${versions_1.tslintToEslintConfigVersion}`, {
        cwd: tempDir,
        stdio: [0, 1, 2],
    });
...
function convertToESLintConfig(pathToTslintJson, tslintJson, ignoreExtendsVals) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (ignoreExtendsVals.length && updatedTSLintJson.extends) {
             ...
             */
            fs_1.mkdirSync(path_1.dirname(pathToTslintJson), { recursive: true });
            fs_1.writeFileSync(pathToTslintJson, JSON.stringify(updatedTSLintJson));
        }
...
function convertTSLintDisableCommentsForProject(tree, projectName) {
    ...
    devkit_1.visitNotIgnoredFiles(tree, root, (filePath) => {
