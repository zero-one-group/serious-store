...
function generateStories(host, schema) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const libConfig = devkit_1.readProjectConfiguration(host, schema.name);
        const libRoot = libConfig.root;
        const cypressProject = project_name_1.getE2eProjectName(schema.name, libRoot, schema.cypressDirectory);
