...
function versions(root, from) {
    return (packageName) => {
        try {
            ...
            return JSON.parse(stripJsonComments(fs_extra_1.readFileSync(packageJsonPath, 'utf-8')))['version'];
        }
        catch (e) {
            return null;
        }
    ...
    return function f(packageName, packageVersion) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (!cache[`${packageName}-${packageVersion}`]) {
                ...
                const json = JSON.parse(stripJsonComments(fs_extra_1.readFileSync(packageJsonPath, 'utf-8')));
                // packageVersion can be a tag, resolvedVersion works with semver
                const resolvedVersion = json.version;
                if (migrationsFilePath) {
                    const json = JSON.parse(stripJsonComments(fs_extra_1.readFileSync(migrationsFilePath, 'utf-8')));
...
function createMigrationsFile(root, migrations) {
    fs_extra_1.writeFileSync(path_1.join(root, 'migrations.json'), JSON.stringify({ migrations }, null, 2));
}
function updatePackageJson(root, updatedPackages) {
    const packageJsonPath = path_1.join(root, 'package.json');
    const packageJsonContent = fs_extra_1.readFileSync(packageJsonPath, 'utf-8');
    ...
    fs_extra_1.writeFileSync(packageJsonPath, JSON.stringify(json, null, 2) + endOfFile);
}
...
function showConnectToCloudMessage() {
    try {
        const nxJson = JSON.parse(stripJsonComments(fs_extra_1.readFileSync('nx.json', 'utf-8')));
...
function runMigrations(root, opts, isVerbose) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const migrations = JSON.parse(stripJsonComments(fs_extra_1.readFileSync(path_1.join(root, opts.runMigrations), 'utf-8'))).migrations;
...
function runNxMigration(root, packageName, name) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const collection = JSON.parse(fs_extra_1.readFileSync(collectionPath, 'utf-8'));
