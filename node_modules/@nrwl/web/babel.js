    ...
    return {
            ...
            [
                ...
                process.env.NODE_ENV === 'test'
                    ...
                    : {
                        ...
                        useBuiltIns: (_a = options.useBuiltIns) !== null && _a !== void 0 ? _a : 'entry',
                        corejs: 3,
        ...
        plugins: [
            !isNxPackage
                ? [
                    require.resolve('@babel/plugin-transform-runtime'),
                    {
                        ...
                        absoluteRuntime: path_1.dirname(require.resolve('@babel/runtime/package.json')),
                    },
                ]
                : null,
            ...
            [
                ...
                (_b = options.decorators) !== null && _b !== void 0 ? _b : { legacy: true },
            ],
            [
                require.resolve('@babel/plugin-proposal-class-properties'),
                (_c = options.classProperties) !== null && _c !== void 0 ? _c : { loose: true },
            ],
        ].filter(Boolean),
        overrides: [
