...
exports.WebpackNxBuildCoordinaionPlugin = void 0;
...
class WebpackNxBuildCoordinaionPlugin {
    ...
    buildChangedProjects() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                child_process_1.execSync(this.buildCmd, { stdio: [0, 1, 2] });
...
exports.WebpackNxBuildCoordinaionPlugin = WebpackNxBuildCoordinaionPlugin;
function sleep(time) {
