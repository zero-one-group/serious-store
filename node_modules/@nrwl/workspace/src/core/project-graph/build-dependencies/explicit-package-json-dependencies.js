...
function buildExplicitPackageJsonDependencies(ctx, nodes, addDependency) {
...
function processPackageJson(sourceProject, fileName, nodes, addDependency) {
    try {
        const deps = readDeps(fileutils_1.parseJsonWithComments(file_utils_1.defaultFileRead(fileName)));
        deps.forEach((d) => {
