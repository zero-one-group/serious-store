...
function moveGenerator(tree, schema) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        move_project_1.moveProject(tree, schema, projectConfig); // we MUST move the project first, if we don't we get a "This should never happen" error 🤦‍♀️
        ...
        update_readme_1.updateReadme(tree, schema, projectConfig);
        update_package_json_1.updatePackageJson(tree, schema, projectConfig);
