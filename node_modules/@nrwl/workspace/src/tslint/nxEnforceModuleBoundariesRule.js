    ...
    constructor(options, projectPath, npmScope, projectGraph, targetProjectLocator) {
        ...
        if (!projectPath) {
            ...
            if (!global.projectGraph) {
                ...
                global.projectGraph = runtime_lint_utils_1.mapProjectGraphFiles(project_graph_1.readCurrentProjectGraph());
            }
...
class EnforceModuleBoundariesWalker extends Lint.RuleWalker {
    ...
    visitImportDeclaration(node) {
        ...
        if (runtime_lint_utils_1.isRelativeImportIntoAnotherProject(imp, this.projectPath, this.projectGraph, filePath, sourceProject) ||
        ...
        // same project => allow
        if (sourceProject === targetProject) {
            if (!this.allowCircularSelfDependency && !fileutils_1.isRelativePath(imp)) {
